...
当前公开测试版本为 `v1.3.0-beta.2`。测试者可从 [GitHub Pre-release](https://github.com/Susurrium/PkuHoleToolkit/releases/tag/v1.3.0-beta.2) 获取命名后的 `.user.js` 附件；安装前请先禁用旧版同名脚本。`beta.1` 存在入口观察器自触发导致页面白屏的问题，已经撤回。
